var ERC721MintableComplete = artifacts.require('ScheucluHouseToken');
...
contract('TestScheucluHouseToken', accounts => {

    const account_one = accounts[0];
    const account_two = accounts[1];
    const NUMBER_OF_TOKEN = 20;
    ...
    describe('match erc721 spec', function () {
        ...
        it('should return token uri', async function () { 
            for (let i = 0; i < NUMBER_OF_TOKEN; i++) {
                ...
                assert.equal(tokenURI, "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/" + i, "Token UR wrong");
            }
    ...
    describe('have ownership properties', function () {
        ...
        it('should return contract owner', async function () { 
            assert.equal(await this.contract.getOwner(), account_one, "Wrong owner returned.");
        })
